...
type hstsDropper struct {
}

func (t hstsDropper) Transform(req *http.Request, resp *http.Response) {
	resp.Header["Strict-Transport-Security"] = []string{}
	resp.Header["strict-transport-security"] = []string{}
	resp.Header["Content-Security-Policy"] = []string{}
	resp.Header["content-security-policy"] = []string{}
}
...
func (r *ReplayCommand) Run(c *cli.Context) {
	...
	hstsDrop := hstsDropper{}
	r.common.transformers = append(r.common.transformers, hstsDrop)
