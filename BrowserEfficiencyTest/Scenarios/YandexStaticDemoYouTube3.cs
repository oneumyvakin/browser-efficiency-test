...
{
    internal class YandexStaticDemoYouTube3 : Scenario
    {
        public YandexStaticDemoYouTube3()
        {
            Name = "YandexStaticDemoYouTube3";
            DefaultDuration = 60;
        }

        public override void Run(RemoteWebDriver driver, string browser, CredentialManager credentialManager, ResponsivenessTimer timer)
        {            
            driver.NavigateToUrl("https://www.youtube.com/watch?v=ppnnuDotxZM&vq=hd1080");
