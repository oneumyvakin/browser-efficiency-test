...
{
    internal class YandexStaticDemoYouTube4 : Scenario
    {
        public YandexStaticDemoYouTube4()
        {
            Name = "YandexStaticDemoYouTube4";
            DefaultDuration = 60;
        }

        public override void Run(RemoteWebDriver driver, string browser, CredentialManager credentialManager, ResponsivenessTimer timer)
        {            
            driver.NavigateToUrl("https://www.youtube.com/watch?v=ZCB-g2B4Y5A&vq=hd1080");
